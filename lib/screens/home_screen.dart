...
class _HighFidelityHomeScreenState extends State<HighFidelityHomeScreen> {
        ...
        children: List.generate(_categories.length, (index) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    isSelected ? const Color(0xFFC67C4E) : const Color(0xFFF3F3F3),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Text(
                _categories[index],
                ...
                Positioned(
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Icons.star, color: Color(0xFFFBBE21), size: 16),
                        const SizedBox(width: 4),
                        Text(
  ...
  Widget _buildBottomNavBar() {
    bool isHomePage =
        GoRouterState.of(context).uri.toString() == '/high_fidelity_home';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildNavBarItem(Icons.home, isActive: isHomePage, onTap: () {
            if (!isHomePage) {
              context.go('/high_fidelity_home');
            }
          }),
          _buildNavBarItem(Icons.favorite_border, isActive: false, onTap: () {}),
          _buildNavBarItem(Icons.shopping_bag_outlined, isActive: false,
              onTap: () => context.go('/high_fidelity_order')),
          _buildNavBarItem(Icons.notifications_none,
